...
const allBusinessNavItems = [
  ...
  { href: "/dashboard/customers", label: "Customers", icon: UserCheck, permission: "orders" },
  { href: "/dashboard/schedule", label: "Schedule", icon: CalendarClock, permission: "conversations" },
